...
// Package domstorage implements the DOMStorage domain. Query and
// modify DOM storage.
package domstorage
...
// domainClient is a client for the DOMStorage domain. Query and
// modify DOM storage.
...
// Disable invokes the DOMStorage method. Disables storage tracking,
...
// Enable invokes the DOMStorage method. Enables storage tracking,
