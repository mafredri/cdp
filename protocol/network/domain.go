...
// Package network implements the Network domain. Network domain allows tracking network activities of the page. It exposes information about http,
...
// domainClient is a client for the Network domain. Network domain allows tracking network activities of the page. It exposes information about http,
// file, data and other requests and responses, their headers, bodies, timing, etc.
...
// ContinueInterceptedRequest invokes the Network method. Response to Network.requestIntercepted which either modifies the request to continue with any
...
// GetAllCookies invokes the Network method. Returns all browser cookies. Depending on the backend support, will return detailed cookie
...
// GetCookies invokes the Network method. Returns all browser cookies for the current URL. Depending on the backend support, will return
...
// ReplayXHR invokes the Network method. This method sends a new XMLHttpRequest which is identical to the original one. The following
