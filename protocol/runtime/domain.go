...
// Package runtime implements the Runtime domain. Runtime domain
// exposes JavaScript runtime by means of remote evaluation and mirror
// objects. Evaluation results are returned as mirror object that
// expose object type, string representation and unique identifier that
// can be used for further object reference. Original objects are
// maintained in memory unless they are either explicitly released or
...
// domainClient is a client for the Runtime domain. Runtime domain
// exposes JavaScript runtime by means of remote evaluation and mirror
// objects. Evaluation results are returned as mirror object that
// expose object type, string representation and unique identifier that
// can be used for further object reference. Original objects are
...
// AwaitPromise invokes the Runtime method. Add handler to promise
// with given promise object id.
...
// CallFunctionOn invokes the Runtime method. Calls function with
// given declaration on the given object. Object group of the result is
...
// DiscardConsoleEntries invokes the Runtime method. Discards
...
// Enable invokes the Runtime method. Enables reporting of execution
// contexts creation by means of `executionContextCreated` event. When
// the reporting gets enabled the event will be sent immediately for
// each existing execution context.
...
// Evaluate invokes the Runtime method. Evaluates expression on global
// object.
...
// GetProperties invokes the Runtime method. Returns properties of a
// given object. Object group of the result is inherited from the
// target object.
...
// GlobalLexicalScopeNames invokes the Runtime method. Returns all
...
// ReleaseObject invokes the Runtime method. Releases remote object
// with given id.
...
// ReleaseObjectGroup invokes the Runtime method. Releases all remote
// objects that belong to a given group.
...
// RunScript invokes the Runtime method. Runs script with given id in
// a given context.
