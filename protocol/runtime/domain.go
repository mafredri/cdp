...
// domainClient is a client for the Runtime domain. Runtime domain exposes JavaScript runtime by means of remote evaluation and mirror objects.
// Evaluation results are returned as mirror object that expose object type, string representation
// and unique identifier that can be used for further object reference. Original objects are
// maintained in memory unless they are either explicitly released or are released along with the
// other objects in their object group.
...
// CallFunctionOn invokes the Runtime method. Calls function with given declaration on the given object. Object group of the result is
...
// Enable invokes the Runtime method. Enables reporting of execution contexts creation by means of `executionContextCreated` event.
...
// GetProperties invokes the Runtime method. Returns properties of a given object. Object group of the result is inherited from the target
// object.
