...
// Package io implements the IO domain. Input/Output operations for
...
// domainClient is a client for the IO domain. Input/Output operations
// for streams produced by DevTools.
...
// Close invokes the IO method. Close the stream, discard any
...
// ResolveBlob invokes the IO method. Return UUID of Blob object
