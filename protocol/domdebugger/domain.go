...
// Package domdebugger implements the DOMDebugger domain. DOM
// debugging allows setting breakpoints on particular DOM operations
...
// domainClient is a client for the DOMDebugger domain. DOM debugging
// allows setting breakpoints on particular DOM operations and events.
// JavaScript execution will stop on these operations as if there was a
...
// GetEventListeners invokes the DOMDebugger method. Returns event
...
// RemoveDOMBreakpoint invokes the DOMDebugger method. Removes DOM
...
// RemoveEventListenerBreakpoint invokes the DOMDebugger method.
...
// RemoveInstrumentationBreakpoint invokes the DOMDebugger method.
...
// RemoveXHRBreakpoint invokes the DOMDebugger method. Removes
...
// SetEventListenerBreakpoint invokes the DOMDebugger method. Sets
