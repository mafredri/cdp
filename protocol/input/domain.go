...
// DispatchKeyEvent invokes the Input method. Dispatches a key event
// to the page.
...
// DispatchMouseEvent invokes the Input method. Dispatches a mouse
// event to the page.
...
// DispatchTouchEvent invokes the Input method. Dispatches a touch
// event to the page.
...
// EmulateTouchFromMouseEvent invokes the Input method. Emulates touch
// event from the mouse event parameters.
...
// SetIgnoreInputEvents invokes the Input method. Ignores input events
// (useful while auditing page).
...
// SynthesizePinchGesture invokes the Input method. Synthesizes a
// pinch gesture over a time period by issuing appropriate touch
// events.
...
// SynthesizeScrollGesture invokes the Input method. Synthesizes a
// scroll gesture over a time period by issuing appropriate touch
// events.
...
// SynthesizeTapGesture invokes the Input method. Synthesizes a tap
