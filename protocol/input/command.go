...
// right (default: 0).
func (a *DispatchMouseEventArgs) SetTiltX(tiltX float64) *DispatchMouseEventArgs {
	a.TiltX = &tiltX
	return a
}
...
func (a *DispatchMouseEventArgs) SetTiltY(tiltY float64) *DispatchMouseEventArgs {
	a.TiltY = &tiltY
	return a
}
