...
// SetModifiers sets the Modifiers optional argument. Bit field representing pressed modifier keys. Alt=1, Ctrl=2, Meta/Command=4, Shift=8
// (default: 0).
...
// SetText sets the Text optional argument. Text as generated by processing a virtual key code with a keyboard layout. Not needed for
...
// SetUnmodifiedText sets the UnmodifiedText optional argument. Text that would have been generated by the keyboard if no modifiers were pressed (except for
...
// SetKey sets the Key optional argument. Unique DOM defined string value describing the meaning of the key in the context of active
...
// SetLocation sets the Location optional argument. Whether the event was from the left or right side of the keyboard. 1=Left, 2=Right (default:
// 0).
...
// SetGestureSourceType sets the GestureSourceType optional argument. Which type of input events to be generated (default: 'default', which queries the platform
...
// SetXOverscroll sets the XOverscroll optional argument. The number of additional pixels to scroll back along the X axis, in addition to the given
// distance.
...
// SetYOverscroll sets the YOverscroll optional argument. The number of additional pixels to scroll back along the Y axis, in addition to the given
// distance.
