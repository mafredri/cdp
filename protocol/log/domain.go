...
// Package log implements the Log domain. Provides access to log
// entries.
package log
...
// Disable invokes the Log method. Disables log domain, prevents
...
// Enable invokes the Log method. Enables log domain, sends the
...
// StartViolationsReport invokes the Log method. start violation
// reporting.
...
// StopViolationsReport invokes the Log method. Stop violation
// reporting.
