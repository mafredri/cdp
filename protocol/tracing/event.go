...
// DataCollectedClient is a client for DataCollected events. Contains
// an bucket of collected trace events. When tracing is stopped
...
// CompleteClient is a client for TracingComplete events. Signals that
// tracing is stopped and there is no trace buffers pending flush, all
