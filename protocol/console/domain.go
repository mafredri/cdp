...
// Package console implements the Console domain. This domain is
...
// domainClient is a client for the Console domain. This domain is
// deprecated - use Runtime or Log instead.
...
// Disable invokes the Console method. Disables console domain,
// prevents further console messages from being reported to the client.
...
// Enable invokes the Console method. Enables console domain, sends
// the messages collected so far to the client by means of the
