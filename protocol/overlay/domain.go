...
// Package overlay implements the Overlay domain. This domain provides
...
// domainClient is a client for the Overlay domain. This domain
// provides various functionality related to drawing atop the inspected
// page.
...
// HighlightFrame invokes the Overlay method. Highlights owner element
// of the frame with given id.
...
// HighlightNode invokes the Overlay method. Highlights DOM node with
...
// HighlightRect invokes the Overlay method. Highlights given
...
// SetInspectMode invokes the Overlay method. Enters the 'inspect'
// mode. In this mode, elements that user is hovering over are
// highlighted. Backend then generates 'inspectNodeRequested' event
...
// SetShowDebugBorders invokes the Overlay method. Requests that
...
// SetShowFPSCounter invokes the Overlay method. Requests that backend
...
// SetShowPaintRects invokes the Overlay method. Requests that backend
...
// SetShowScrollBottleneckRects invokes the Overlay method. Requests
// that backend shows scroll bottleneck rects
...
// SetShowViewportSizeOnResize invokes the Overlay method. Paints
