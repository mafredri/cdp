...
type HighlightFrameArgs struct {
	FrameID             protocol.PageFrameID `json:"frameId"`                       // Identifier of the frame to highlight.
...
func NewHighlightFrameArgs(frameID protocol.PageFrameID) *HighlightFrameArgs {
