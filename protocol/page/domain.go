...
// Package page implements the Page domain. Actions and events related
// to the inspected page belong to the page domain.
package page
...
// domainClient is a client for the Page domain. Actions and events
// related to the inspected page belong to the page domain.
...
// AddScriptToEvaluateOnLoad invokes the Page method. Deprecated,
...
// AddScriptToEvaluateOnNewDocument invokes the Page method. Evaluates
// given script in every frame upon creation (before loading frame's
// scripts).
...
// BringToFront invokes the Page method. Brings page to front
// (activates tab).
...
// CreateIsolatedWorld invokes the Page method. Creates an isolated
...
// Disable invokes the Page method. Disables page domain
// notifications.
...
// GetFrameTree invokes the Page method. Returns present frame tree
// structure.
...
// GetLayoutMetrics invokes the Page method. Returns metrics relating
// to the layouting of the page, such as viewport bounds/scale.
...
// GetNavigationHistory invokes the Page method. Returns navigation
// history for the current page.
...
// GetResourceContent invokes the Page method. Returns content of the
// given resource.
...
// GetResourceTree invokes the Page method. Returns present frame /
...
// HandleJavaScriptDialog invokes the Page method. Accepts or
// dismisses a JavaScript initiated dialog (alert, confirm, prompt, or
// onbeforeunload).
...
// Navigate invokes the Page method. Navigates current page to the
// given URL.
...
// NavigateToHistoryEntry invokes the Page method. Navigates current
// page to the given history entry.
...
// Reload invokes the Page method. Reloads given page optionally
// ignoring the cache.
...
// RemoveScriptToEvaluateOnLoad invokes the Page method. Deprecated,
...
// RemoveScriptToEvaluateOnNewDocument invokes the Page method.
...
// ScreencastFrameAck invokes the Page method. Acknowledges that a
// screencast frame has been received by the frontend.
...
// SearchInResource invokes the Page method. Searches for given string
// in resource content.
...
// SetAdBlockingEnabled invokes the Page method. Enable Chrome's
// experimental ad filter on all sites.
...
// SetAutoAttachToCreatedPages invokes the Page method. Controls
// whether browser will open a new inspector window for connected
// pages.
...
// SetDocumentContent invokes the Page method. Sets given markup as
// the document's HTML.
...
// SetLifecycleEventsEnabled invokes the Page method. Controls whether
// page will emit lifecycle events.
...
// StartScreencast invokes the Page method. Starts sending each frame
// using the `screencastFrame` event.
...
// StopLoading invokes the Page method. Force the page stop all
// navigations and pending resource fetches.
...
// StopScreencast invokes the Page method. Stops sending each frame in
// the `screencastFrame`.
