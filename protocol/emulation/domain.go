...
// Package emulation implements the Emulation domain. This domain
...
// domainClient is a client for the Emulation domain. This domain
// emulates different environments for the page.
...
// ResetPageScaleFactor invokes the Emulation method. Requests that
// page scale factor is reset to initial values.
...
// SetCPUThrottlingRate invokes the Emulation method. Enables CPU
// throttling to emulate slow CPUs.
...
// SetDefaultBackgroundColorOverride invokes the Emulation method.
...
// SetDeviceMetricsOverride invokes the Emulation method. Overrides
// the values of device screen dimensions (window.screen.width,
...
// SetEmulatedMedia invokes the Emulation method. Emulates the given
// media for CSS media queries.
...
// Geolocation Position or Error. Omitting any of the parameters
...
// SetPageScaleFactor invokes the Emulation method. Sets a specified
// page scale factor.
...
// SetScriptExecutionDisabled invokes the Emulation method. Switches
...
// SetTouchEmulationEnabled invokes the Emulation method. Enables
// touch on platforms which do not support them.
...
// SetVirtualTimePolicy invokes the Emulation method. Turns on virtual
// time for all frames (replacing real-time with a synthetic time
// source) and sets the current virtual time policy. Note this
...
// SetVisibleSize invokes the Emulation method. Resizes the
// frame/viewport of the page. Note that this does not affect the
