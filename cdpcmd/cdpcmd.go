...
func (a *InputDispatchKeyEventArgs) SetTimestamp(timestamp float64) *InputDispatchKeyEventArgs {
...
// SetTimestamp sets the Timestamp optional argument. Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
func (a *InputDispatchMouseEventArgs) SetTimestamp(timestamp float64) *InputDispatchMouseEventArgs {
	a.Timestamp = &timestamp
	return a
}
...
// SetTimestamp sets the Timestamp optional argument. Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
func (a *InputDispatchTouchEventArgs) SetTimestamp(timestamp float64) *InputDispatchTouchEventArgs {
	a.Timestamp = &timestamp
	return a
}
